...
from ml_engine.xgboost_model import XGBoostModel, create_pretrained_model, load_pretrained_model

# Configure logging
from utils.logging_config import get_logger
logger = get_logger("ml_engine.xgboost_integration")
...
XGBOOST_GPU_ID = int(os.environ.get("XGBOOST_GPU_ID", "0"))
