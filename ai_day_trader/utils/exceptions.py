...
class ModelRegistryError(ModelError):
    """Error related to model registry operations"""
    pass


class ModelDeploymentError(ModelError):
    """Error related to model deployment operations"""
    pass


class HealthCheckError(TradingSystemError):
...
class StockSelectionError(TradingSystemError):
    """Error related to stock selection operations"""
    pass


class RiskError(TradingSystemError):
    """Error related to risk management operations"""
    pass
